...
(sample_result, sample_genes, sample_scores) = GA(GAtrain, GAvalid, linear_model.LinearRegression(), feval, iter=150, r_sample=0.9, r_crossover=0.5, r_vary=0.005, r_keep_best = 0.01, popsize = len(ytr), verbose = True).select()
