...
#sample_genes = [False,True,True,True,False, True, True, True, True, False, False, True,
...
Xtr_idx = rand_idx[:tr_len+vald_len]
Xtr_new = Xs[, sample_genes]
ytr_new = ys[Xtr_idx]
